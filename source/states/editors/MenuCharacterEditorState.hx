...
class MenuCharacterEditorState extends states.MusicBeatState
{
	...
	override function create() {
		...
		tipText.setFormat(backend.Paths.uiFont, 16, FlxColor.WHITE, CENTER);
	...
	function reloadSelectedCharacter() {
		...
		char.alpha = 1;
		char.frames = backend.Paths.getSparrowAtlas('menucharacters/' + characterFile.image);
